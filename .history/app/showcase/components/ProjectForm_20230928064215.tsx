...
const ProjectForm = ({ type, session, project }: Props) => {
    ...
    <label htmlFor="image" className="flexCenter form_image-label"> {/* Changed "htmlFor" to match input id */}
    ...
    {form.image && (
        ...
        />
            ...
            <FormField
                ...
                placeholder="https://bloopglobal.com"
            ...
            <FormField
                ...
                placeholder="https://github.com/buzzedison"
