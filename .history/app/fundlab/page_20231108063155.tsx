  ...
  <div className="container mx-auto">
    <div className="text-center">
      ...
      <p className="text-lg mb-8">
        To discuss investment or donation opportunities, reach out to us through the following contact points:
      </p>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Contact Point 1 */}
        <div className="p-6 rounded shadow bg-gray-700">
          <h3 className="text-xl font-bold mb-2">Email</h3>
          <p className="text-gray-400">info@fundlab.com</p>
        </div>
        {/* Contact Point 2 */}
        <div className="p-6 rounded shadow bg-gray-700">
