  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-red-100 text-gray-900">
      ...
      <section className="text-center py-24">
        ...
        <Link href="/consultation"className="bg-blue-600 text-white px-8 py-3 rounded-lg font-bold text-lg hover:bg-primary transition duration-300">Schedule a Consultation
        </Link>
      </section>
      </div>
      {/* Grid Section 1 */}
