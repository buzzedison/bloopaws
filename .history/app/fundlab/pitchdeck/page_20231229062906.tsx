...
const Home: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-red-100 text-gray-900">
      <Head>
      ...
      <section className="text-center py-24">
        ...
        <Link href="/consultation"className="bg-blue-600 text-white px-8 py-3 rounded-lg font-bold text-lg hover:bg-blue-700 transition duration-300">Schedule a Consultation
        </Link>
      </section>
      </div>
      {/* Grid Section 1 */}
      ...
      <section className="text-center py-24 bg-blue-600 text-white">
        ...
        <Link href="/consultation"className="bg-white text-blue-600 px-8 py-3 rounded-lg font-bold text-lg hover:bg-gray-200 transition duration-300">Schedule a Consultation
        </Link>
      </section>
    </div>
  );
