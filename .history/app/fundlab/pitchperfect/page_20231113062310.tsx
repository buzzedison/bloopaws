    ...
    <>
      ...
      <main className=" bg-white">
        ...
        <section className="text-center p-12 bg-red-700 text-white">
          <h1 className="text-5xl font-bold mb-6 pt-24 mt-12">Bring Your Visions to Life</h1>
...
<section className="py-12 px-6 bg-red-100">
  <h2 className="text-4xl font-bold text-gray-800 mb-8 text-center">Pitch Your Startup Idea</h2>
  <div className="flex justify-center space-x-4">
    {/* Card 1 */}
    <div className="max-w-sm bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300 p-6 text-center">
    ...
    <div className="max-w-sm bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300 p-6 text-center">
      ...
      <p className="text-gray-600">Enjoy the fame as we feature your brand in the virtual square.</p>
        ...
        <section className="text-center p-12 bg-red-600 text-white">
          ...
          <p className="text-lg mb-8">Sharpen your pitch, set up your backdrop, and get ready to charm screens across the globe.
          Doesn’t matter if you're chasing capital or not, here's your spotlight to shine and capture the attention your venture deserves.</p>
          <p> Doesn’t matter if you're chasing capital or not, here's your spotlight to shine and capture the attention your venture deserves.</p>
          <button className="bg-white text-red-600 font-semibold py-3 px-6 rounded-lg hover:bg-gray-200 transition duration-300">
            Register Now
          </button>
        </section>
