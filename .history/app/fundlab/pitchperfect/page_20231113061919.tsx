  ...
  return (
    <>
      ...
      <main className=" bg-white">
       ...
       <p> Are you a business owner with untapped innovations
An aspiring entrepreneur with big dreams?
A working professional plotting your next venture?
...
<section className="py-12 px-6 bg-red-100">
  <h2 className="text-4xl font-bold text-gray-800 mb-8 text-center">What’s the Buzz?</h2>
