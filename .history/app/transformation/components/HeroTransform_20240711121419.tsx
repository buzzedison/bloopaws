  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <section className="flex flex-col lg:flex-row items-center justify-center min-h-screen bg-gradient-to-br from-red-50 to-pink-100 overflow-hidden">
        <motion.div
          className="flex-1 p-8 lg:p-16 max-w-2xl mx-auto"
          initial="initial"
          animate="animate"
        ...
        >
          <motion.h1
            variants={fadeInUp}
            className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-red-600 mb-6 text-center lg:text-left"
          >
            Embrace Digital Transformation
          </motion.h1>
          <motion.p
            variants={fadeInUp}
            className="text-red-800 text-lg md:text-xl mb-8 text-center lg:text-left"
          >
