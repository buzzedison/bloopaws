...
const Services = () => {
  const servicesData = [
    ...
    { name: 'Mobile + Product Development', image: '/images/mobile.svg' },
    { name: 'Business Development and Fundraising', image: '/images/business.svg' },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12">
            {servicesData.map((service, index) => (
              <motion.div 
                ...
                className="p-8 border-2 border-gray-200 hover:border-indigo-500 rounded-lg">
                <Image 
                  src={service.image}
                  width={80}
                  height={80}
