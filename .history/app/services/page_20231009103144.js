    ...
    return (
        <div className="font-sans antialiased text-gray-900">
            ...
            <section className="relative hero-section overflow-hidden">
                <Image src="/images/back.png" layout="fill" objectFit="cover" alt="Services Hero" />
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center bg-black bg-opacity-50 text-white">
                    <motion.h1 initial={{ y: -50 }} animate={{ y: 0 }} className="text-6xl font-bold">
                        Our Services
                    </motion.h1>
                        ...
                        {servicesData.map((service, index) => (
                            <Link href={service.link} key={index}>
                                <motion.div
                                    ...
                                    animate="visible"
                                    custom={index}
                                    className="p-8 border-2 border-gray-200 hover:border-red-500 rounded-lg cursor-pointer transition-all duration-300"
                                >
                                    <Image src={service.image} width={80} height={80} alt={`${service.name} Icon`} />
            ...
            {/* CTA Section */}
            <section className="cta-section py-16 bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 text-white">
                <div className="container mx-auto text-center">
                    ...
                    <Link href="/get-started">
                        <button className="bg-white text-black px-8 py-3 text-xl font-bold rounded-full hover:bg-opacity-80 transition-colors duration-300 cursor-pointer">
                            Get Started
                        </button>
                    </Link>
                </div>
