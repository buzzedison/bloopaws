...
export default function WebDevServices() {
  const techStacks = ['React', 'Node.js', 'Django', 'GraphQL', 'MySQL', 'MongoDB', 'AWS', 'Docker'];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-blue-500 text-white p-16 text-center">
        ...
        <Link href="/contact">
          <a className="bg-white text-blue-500 px-8 py-2 rounded-full text-lg font-semibold hover:bg-gray-300">
            Get Started
          </a>
        </Link>
      </section>
