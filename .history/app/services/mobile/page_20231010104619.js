    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-[600px] flex items-center justify-center text-center bg-purple-900">
        ...
        <div className="relative z-10">
          ...
          <p className="mt-4 text-lg text-gray-200 max-w-2xl mx-auto tex-whitet">We deliver exceptional mobile + product development solutions tailored to your unique needs.</p>
        </div>
      </section>
