...
export default function MobileProdDevServices() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="relative h-[600px] flex items-center justify-center text-center bg-purple-800">
        ...
        <div className="relative z-10">
          ...
          <p className="mt-4 text-lg text-gray-200 max-w-2xl mx-auto">We deliver exceptional mobile + product development solutions tailored to your unique needs.</p>
        </div>
      </section>
      ...
      <section id="services" className="container mx-auto my-16 p-10">
        ...
        <ul className="text-gray-700 text-center grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {services.map((service, i) => (
            <li key={i} className="p-6 bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 ease-in-out hover:bg-green-50">
              {service}
            </li>
          ))}
        </ul>
      ...
      {/* CTA Section */}
      <section className="bg-green-500 text-white p-16 text-center">
        ...
        <Link href="/contact">
          <button className="bg-white text-green-500 px-8 py-2 rounded-full text-lg font-semibold hover:bg-gray-300">
            Get Started
          </button>
        </Link>
      </section>
