      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <section id="services" className="container mx-auto p-10">
                  ...
                  {services.map((service, i) => (
                      <div key={i} className="flex flex-col bg-red-50 shadow-lg rounded-lg overflow-hidden transition-all duration-500 ease-in-out transform hover:shadow-2xl hover:scale-105">
                          ...
                          <div className="p-6">
                              ...
                              <p className="text-gray-600 px-10 py-5">
                                  {service.items.join(', ')}
                              </p>
                          </div>
                      </div>
              ...
              <CallToAction>
                  ...
                  <Link href="/contact">
                      <button className="btn btn-primary bg-white text-red-500 px-3 py-2 rounded-lg hover:bg-black hover:text-white">Contact Us</button>
                  </Link>
              </CallToAction>
