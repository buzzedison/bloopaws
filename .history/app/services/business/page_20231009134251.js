        ...
        <div className="min-h-screen bg-gray-50 font-sans">
            ...
            <section id="services" className="container mx-auto p-10">
                ...
                <p className="text-lg text-gray-600 text-center pb-10">
                    ...
                    <Link href="/services"className="text-red-600 underline">Learn more about our services
                    </Link> 
                    or 
                    <Link href="/contact"className="text-red-600 underline">schedule a consultation
                    </Link> 
