...
export default function Services() {
  ...
  return (
    <section id="services" className="container mx-auto p-10">
      <h2 className="text-4xl font-bold text-center pb-5 pt-12">Business Development, Funding, and Advisory Services</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-10">
        {services.map((service, i) => (
          <div key={i} className="flex flex-col bg-white shadow-lg rounded-lg overflow-hidden transition-all duration-500 ease-in-out transform hover:shadow-2xl hover:scale-105">
