...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      items: [
        ...
        'Curiculum review and development',
  ...
  return (
    <section id="services" className="container mx-auto p-10">
      ...
      <p className="text-lg text-gray-600 text-center pb-10 md:px-24">
      We help ambitious companies scale and accelerate growth through tailored business strategy, funding advisory, and partnership development. 
      </p>
      ...
      <p className="text-lg text-gray-600 text-center pb-10">
        Our team has decades of experience supporting high-growth companies across industries. <a href="/services" className="text-red-600 underline">Learn more about our services</a> or <a href="/contact" className="text-red-600 underline">schedule a consultation</a> to discuss how we can help take your business to the next level.
      </p>

      <CallToAction>
        <div className="text-2xl pb-2">Ready to Grow?</div>
        <div className="text-lg pb-4">Schedule a consultation today.</div>
        <Link href="/contact" className="btn btn-primary bg-white text-red-500 px-3 py-2 rounded-lg hover:bg-black hover:text-white">Contact Us</Link>
      </CallToAction>
