...
export default function Services() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            {/* Hero Section */}
            <section className="relative h-[600px] flex items-center justify-center text-center bg-red-50">
                <Image src="/images/hero-bg.jpg" layout="fill" objectFit="cover" alt="Business Development" className="absolute z-0" />
                <div className="relative z-10">
                    <h1 className="text-6xl font-extrabold text-white">Business Development, Funding, and Advisory Services</h1>
    ...
    <Link href="/contact" className="btn btn-primary bg-white text-red-500 px-3 py-2 rounded-lg hover:bg-black hover:text-white">
        Contact Us
    </Link>
</CallToAction>
