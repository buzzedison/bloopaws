    ...
    <div className="container mx-auto p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {posts.map((post, index) => (
          <motion.div
            key={post._id}
            className="bg-white p-8 rounded-lg shadow-lg transition-transform transform-gpu hover:scale-105"  // Updated classes here
          ...
          >
            <div className="relative h-[200px] mb-4">  // Added margin-bottom here
              {post.mainImage && (
                <Image
