...
export default function IdeaToCompanySection() {
  ...
  const tabs = [
    {
      label: "How we do it",
      content: "We identify great ideas. We are always on the lookout for great ideas that have the potential to make a real impact. We look for ideas that are solving a real problem, that have a large addressable market, and that are led by a strong team. We build strong teams. Once we have identified a great idea, we work to build a strong team around it. We look for people who are passionate about the idea, who have the skills and experience to execute on the plan, and who are aligned with our values. We execute on a plan. Once we have a strong team in place, we develop a plan to execute on the idea. This plan includes everything from the product roadmap to the marketing strategy.We raise capital. In order to bring an idea to market, we need to raise capital. We work with investors who share our vision for the company and who are committed to helping us succeed.",
    },
    {
