...
<div class="flex justify-center mt-6">
  <form>
    <div class="relative">
      <input
        class="px-24 pl-28 rounded-2xl border-spacing-1 border-2 py-4"
        type="text"
      />
      <button
        class="absolute right-0 top-0 bottom-0 m-1 bg-red-600 hover:bg-black text-white px-6 py-4 rounded-2xl"
      >
     Get Started
      </button>
    </div>
