...
export default function IdeaToCompanySection() {
  ...
  const tabs = [
    {
      label: "How we do it",
      content: "We identify great ideas. We are always on the lookout for great ideas that have the potential to make a real impact. We look for ideas that are solving a real problem, that have a large addressable market, and that are led by a strong team. We build strong teams. Once we have identified a great idea, we work to build a strong team around it. We execute on a plan. We raise capital and make magic happen!",
    },
    {
      label: "What we do",
      content: "We provide strategic guidance. We help our partners develop their business plans, identify their target markets, and create their go-to-market strategies.We connect our partners with the right resources. We have a wide network of contacts in the startup world, and we are able to connect our partners with the resources they need to succeed.",
    },
  ];
      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 flex flex-col justify-center">
          <div className="mx-auto md:ml-8">
            ...
            {/* Tabs */}
            <Tabs className="text-gray-600" tabs={tabs} />
          </div>
        </div>
      </div>
    </div>
