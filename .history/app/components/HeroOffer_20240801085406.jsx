...
export default function HeroOffer() {
  return (
    <div className="flex flex-col md:flex-row h-screen bg-white">
      <div className="md:w-1/2 flex flex-col justify-center px-8 py-16 bg-red-600 text-white h-full">
        <div className="max-w-md mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 animate-fade-in animate-delay-200">
            Don't Miss Out!
            <span className="block mt-2">50% Off Website Design & Development</span>
          </h1>
      ...
      <div className="md:w-1/2 flex items-center justify-center h-full bg-white">
