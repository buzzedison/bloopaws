...
export default function Navbar() {
  ...
  return (
    <nav className="container ">
      <div className="flex items-center justify-between p-6 text-white font-roboto">
        ...
        <div className={`text-white lg:flex items-center space-x-8 ${isNavOpen ? 'hidden lg:block' : 'hidden'}`}>
          {/* Desktop Menu Links */}
