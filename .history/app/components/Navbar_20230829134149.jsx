    ...
    <nav className="container">
      <div className="flex items-center justify-between p-6 text-black font-roboto">
        ...
        <div className={`lg:flex items-center space-x-8 ${isNavOpen ? 'hidden lg:block' : 'hidden'}`}>
          <Link href="/about">
            <a className="hover:text-gray-700 transition ease-in-out duration-200 text-white">
              About Us
            </a>
          </Link>
          <Link href="/services">
          ...
          <div className="relative group">
            ...
            <div className={`py-2 px-5 absolute left-0 z-10 mt-2 space-y-2 bg-white rounded shadow-lg ${isDropdownOpen ? 'block' : 'hidden'} group-hover:block`}>
              <Link href="/guides"><a className="block px-4 py-2 hover:bg-gold hover:text-wine transition ease-in-out duration-200">Guides</a></Link>
              <Link href="/tools"><a className="block px-4 py-2 hover:bg-gold hover:text-wine transition ease-in-out duration-200">Tools</a></Link>
              <Link href="/insights"><a className="block px-4 py-2 hover:bg-gold hover:text-wine transition ease-in-out duration-200">Insights</a></Link>
            </div>
          </div>
          <div>
