...
const sections = [
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-24 h-24">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 21H5a2 2 0 01-2-2v-5a2 2 0 012-2h4m10 9h-4m4-7h-4m0 0a2 2 0 012-2h4a2 2 0 012 2v5a2 2 0 01-2 2h-4a2 2 0 01-2-2m0 0H9" />
      </svg>
    ),
    button: {
      text: "Learn More",
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-24 h-24">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 20h9M12 4h9M12 12h9M3 12a2 2 0 012-2h5a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V12z" />
      </svg>
    ),
    button: {
      text: "Check Us Out",
