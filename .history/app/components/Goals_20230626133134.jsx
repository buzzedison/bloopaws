      ...
      <div className="flex flex-col md:flex-row items-center justify-between border-b-2 md:border-b-0 border-gray-300">
        <div className="md:w-1/2 p-4 text-center md:text-left">
          ...
          <Link href="/request-info" passHref>
            <button className="inline-block bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700">Request info</button>
          </Link>
        </div>
        <div className="md:w-1/2 p-4 text-center md:text-right">
          ...
          <Link href="/get-started" passHref>
            <button className="inline-block bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700">Get started</button>
          </Link>
        </div>
      </div>
    </div>
