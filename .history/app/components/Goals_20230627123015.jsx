        ...
        <div className="container mx-auto px-4 py-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {sections.map((section) => (
              <div key={section.title} className="bg-white shadow-lg rounded-lg overflow-hidden flex flex-col py-12 px-8">
                <Image className="w-full" src={section.image} alt={section.alt} width={600} height={200} />
                <div className="p-4 flex flex-col justify-between flex-grow">
                  <div>
                    <h2 className="text-2xl font-bold mb-2 py-12 px-8">{section.title}</h2>
