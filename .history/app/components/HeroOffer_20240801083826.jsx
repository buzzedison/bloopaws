    ...
    <section className="relative min-h-screen bg-gradient-to-br from-purple-600 to-indigo-800 overflow-hidden">
      <div className="container mx-auto px-4 py-20 flex flex-col lg:flex-row items-center justify-between">
        ...
        >
          ...
          >
            <Link 
              href="https://airtable.com/appN08604EcWr0e4L/pagPlniVKUdd9LlZZ/form"
              className="inline-block bg-yellow-400 hover:bg-yellow-300 text-purple-900 font-bold py-4 px-8 rounded-full text-xl transition duration-300 ease-in-out transform hover:scale-105 shadow-lg"
            >
              Grab This Deal
            </Link>
          </motion.div>
