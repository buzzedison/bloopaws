...
import type { NextRequest } from 'next'; // Import NextRequest type
...
export default async function handler(request: NextRequest) { // Change req to request and add NextRequest type
