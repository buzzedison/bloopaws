      ...
      <div className=" bg-red-800 text-white py-20">
        <div className="container mx-auto text-center h-56 md:h-96">
          ...
          <div className="space-x-4">
            <a href="#signup" className="bg-black text-white px-8 py-3 rounded-full font-semibold">Sign Up</a>
            <a href="#learn-more" className="bg-transparent border border-red-200 text-red-200 px-8 py-3 rounded-full font-semibold">Learn More</a>
          </div>
        </div>
      </div>
    );
