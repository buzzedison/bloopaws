  ...
  return (
    <div className="bg-gray-100">
      ...
      <div className="bg-blue-600 text-white p-16 text-center">
        ...
        <div>
          <Link href="/sign-up"className="bg-red-500 text-white py-2 px-6 rounded-full mr-4">Sign Up
          </Link>
          <Link href="/learn-more"className="bg-white text-blue-600 py-2 px-6 rounded-full">Learn More
          </Link>
        </div>
      </div>
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 p-8">
        {courses.map((course, index) => (
          <div key={index} className="bg-white p-8 rounded-lg shadow-lg">
            ...
            <Link href={course.learnMoreUrl}className="text-blue-500 underline">Learn More
            </Link>
          </div>
        ))}
      </div>
