            ...
            <div className="container mx-auto mt-24 ">
                ...
                <div className="flex flex-col md:flex-row items-center mb-16 px-0">
                    <div className="md:w-1/2 text-center md:text-left mb-8 md:mb-0">
                        ...
                        <p className="text-lg mb-8 pr-0 md:pr-12">Let's be real - every business needs money to reach its potential. But landing the right funding can be a challenge without proper preparation.</p>
                ...
                <div className="bg-red-800 p-8 rounded-lg shadow-lg text-white px-2 md:px-12 py-2 md:py-24">
