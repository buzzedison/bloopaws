    ...
    return (
      <div className="py-16">
        <div className="container mx-auto">
          ...
          <p className="mb-8 md:mb-12 w-2/3 text-2xl">
...
<div className="flex flex-row ">
  <div className="w-1/2 pr-4 md:pr-12">
        ...
        <p className="text-lg mb-8 font-bold text-red-700">
        ...
        <div className="w-1/2">
<Image className="px-0 md:px-4" src="/images/aievent.png" width={500} height={500} alt="AI Event"/>
     </div>
        </div>
