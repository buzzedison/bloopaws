...
export default function AICourseDescription() {
    return (
      <div className="py-16">
        ...
        <p className="text-lg mb-8">
          You’ll finish ready to implement a strategic AI plan tailored to your business. Drive growth by increasing creativity, innovation, and competitive edge.
          Don't miss this opportunity. Join the AI revolution today and unlock your full business potential.
        </p>
        <a href="#signup" className="text-blue-500 text-lg font-bold">Sign Up</a>
        <span className="mx-2">|</span>
        <a href="#details" className="text-blue-500 text-lg font-bold">Learn More</a>
