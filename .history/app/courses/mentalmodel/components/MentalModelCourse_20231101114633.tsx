            ...
            <div className="container mx-auto">
                ...
                <div className="flex flex-col md:flex-row items-center mb-16">
                    ...
                    <div className="md:w-1/2">
                        <Image src="/images/mental-models.png" width={500} height={500} alt="Mental Models" className="rounded-xl"/>
                    </div>
                </div>

                {/* Course Details Section */}
                <div className="bg-purple-800 p-8 rounded-lg shadow-lg text-white">
                    <h2 className="text-2xl font-bold mb-4">Unlock Next-Level Critical Thinking</h2>
