...
export default function Home() {
  return (
    <div className="bg-gradient-to-br from-red-50 to-red-100 min-h-screen p-8">
      ...
      {/* Hero Section */}
      <div className="relative h-screen bg-gradient-to-r from-red-500 to-red-700 rounded-xl p-10 text-white shadow-2xl">
        <h1 className="text-6xl font-extrabold mb-4">Explore Our Resource Collections</h1>
        <p className="text-2xl mb-4">We offer a cornucopia of resources—games, templates, insights from whitepapers, and educational courses—to meet your every need.</p>
