      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {blog.map((post) => (
          ...
          >
            ...
            />
         {/* <Link href={`/blog/${post.uri}`} as={`/blog/${post.uri}`}className="text-blue-500 hover:underline mt-2">Learn more
      </Link> */}

<Link href={`/blog/${encodeURIComponent(post.uri)}`}className="text-blue-500">Learn More
</Link>
