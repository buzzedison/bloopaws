      ...
      <main >
        ...
        <section className="bg-red-200 text-black text-center py-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="mb-6">
              Imagine a high-converting website that attracts your ideal customers like a magnet. We have got you covered - from stunning design, compelling copywriting that triggers action, to technical development, engaging sales funnels, social media marketing, and advanced SEO optimization.
            </p>
