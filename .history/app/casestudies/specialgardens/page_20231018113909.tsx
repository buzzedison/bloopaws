...
/>
    ...
    <CaseStudyDescription
        ...
        results= "Over 300% increase in customer inquiries in 6 months.Website now primary driver of sales leads. Improved Google search ranking for relevant keywords.Faster response to leads with online contact forms.Positive feedback on user experience from site visitors"
      >
