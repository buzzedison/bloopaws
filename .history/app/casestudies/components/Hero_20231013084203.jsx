...
export default function CaseStudies() {
    return (
      <div className="min-h-screen bg-blue-100 p-10 bg-center bg-cover" style={{ backgroundImage: 'url(/images/casehome.jpg)' }}>
        <div className="max-w-7xl mx-auto">
          <h1 className="text-5xl font-bold mt-24 text-purple-900">Revamping MyCo's Online Presence</h1>
          <p className="text-xl mt-20 text-purple-700">
          ...
          <div className="relative mb-10 h-56 md:h-96 "></div>
