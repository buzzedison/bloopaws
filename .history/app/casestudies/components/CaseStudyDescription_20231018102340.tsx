...
const CaseStudyDescription: React.FC<Props> = ({ title, description, links, imageUrl, challenge, solution, results }) => {
  return (
    <motion.div className="p-10 bg-white rounded-xl shadow-2xl space-y-10" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
      ...
      {/* Challenge */}
      {challenge && (
        <motion.div className="bg-blue-100 p-6 rounded-xl shadow-lg space-y-6" initial={{ y: -50 }} animate={{ y: 0 }} transition={{ duration: 0.5, delay: 0.2 }}>
      ...
      {/* Solution */}
      {solution && (
        <motion.div className="bg-green-100 p-6 rounded-xl shadow-lg space-y-6" initial={{ y: -50 }} animate={{ y: 0 }} transition={{ duration: 0.5, delay: 0.3 }}>
      ...
      {/* Results */}
      {results && (
        <motion.div className="bg-yellow-100 p-6 rounded-xl shadow-lg space-y-6" initial={{ y: -50 }} animate={{ y: 0 }} transition={{ duration: 0.5, delay: 0.4 }}>
