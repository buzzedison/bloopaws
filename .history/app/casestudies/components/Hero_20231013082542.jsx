  ...
  return (
    <div className="min-h-screen bg-blue-100 p-10">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-5xl font-bold mb-6 text-blue-900">Revamping MyCo's Online Presence</h1>
        <p className="text-xl mb-10 text-blue-700">The founders of MyCo knew there had to be a better way to manage customer relations. After countless late nights and many cups of coffee, they cracked the code - 
        a revolutionary app called My Center Office (MyCo)..</p>
