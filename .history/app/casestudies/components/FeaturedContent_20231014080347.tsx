...
const FeaturedContent: React.FC = () => {
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center p-10 bg-grey-100 space-y-6 md:space-y-0">
      
        {/* Left - Image Section */}
        <div className="w-full md:w-1/2 relative h-56 md:h-96">
          <Image src="/images/workwoman.jpg" alt="Woman reading" layout="fill" objectFit="cover" className="rounded-lg" />
        </div>
      ...
      <div className="flex flex-col md:flex-row-reverse justify-between items-center p-10 bg-white space-y-6 md:space-y-0">
