  ...
  return (
    <div className="min-h-screen p-4 sm:p-6 lg:p-10" style={{ backgroundImage: 'url(/images/casehome.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
      <div className="max-w-7xl mx-auto py-12 sm:py-16 lg:py-20 rounded-xl mt-12 sm:mt-16 lg:mt-24">
        ...
        mb-6 sm:mb-8 text-white text-center p-2 sm:p-4 w-full md:w-3/4 flex items-center ">
          The founders of MyCo knew there had to be a 
          better way to manage customer relations. 
          After countless late nights and many cups of coffee, 
          they cracked the code - a revolutionary app called My Center Office 
          (MyCo).
        </p>
