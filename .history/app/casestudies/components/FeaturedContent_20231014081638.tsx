...
const FeaturedContent: React.FC = () => {
  const imageStyle = {
    backgroundImage: 'url(/images/workwoman.jpg)',
  ...
  return (
    <div className="bg-red-50 ">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center p-10 space-y-6 md:space-y-0">
        ...
        {/* Left - Image Section */}
        <div className="w-full md:w-1/2 h-56 md:h-96 rounded-lg" style={imageStyle}>
      ...
      <div className="flex flex-col md:flex-row-reverse justify-between items-center md:space-y-0">
        ...
        {/* Right - Image Section */}
        <div 
          className="w-full md:w-1/2 h-56 md:h-96 rounded-lg" 
          style={{ backgroundImage: 'url(/images/workwoman.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}
        ></div>
