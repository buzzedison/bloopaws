  ...
  return (
    <div className="relative min-h-screen bg-gray-200">
      ...
      <div className="absolute bottom-0 left-0 z-10 flex flex-col p-8 text-white space-y-4">
        ...
        <button className="w-1/2 px-6 py-3 font-semibold rounded bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50">
          {buttonText}
        </button>
      </div>
    </div>
