    ...
    <div className="bg-red-50 ">
      ...
      <div className="flex flex-col md:flex-row-reverse justify-between items-center md:space-y-0">
        ...
        <div className="w-full md:w-1/2  md:px-10 sm:px-4 py-0 sm:py-4">
          <h1 className="text-4xl font-bold text-gray-900 py-4">Introducing Crowdpen for African Writers</h1>
          <p className="text-lg text-gray-700">
          ...
          <Link href="#" className="text-blue-600 font-medium hover:underline hover:text-blue-800 transition duration-300">Learn more →</Link>
        </div>
      </div>
    </div>
  );
