    ...
    <div className="min-h-screen p-10" style={{ backgroundImage: 'url(/images/casehome.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
      <div className="max-w-7xl mx-auto py-20  rounded-xl mt-24">
        ...
        <p className="text-xl mb-10 text-white text-center ">
          The founders of MyCo knew there had to be a better way to manage customer relations.<br/> After countless late nights and many cups of coffee, they cracked the code - a revolutionary app called My Center Office (MyCo).
        </p>
