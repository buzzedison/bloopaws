...
const CaseStudyDescription: React.FC<Props> = ({ title, description, links, imageUrl, challenge, solution, results }) => {
  return (
    <div className="p-10 bg-white rounded-xl shadow-2xl space-y-10">
      ...
      {/* Challenge */}
      {challenge && (
        <div className="bg-blue-100 p-6 rounded-xl shadow-lg space-y-6">
      ...
      {/* Solution */}
      {solution && (
        <div className="bg-green-100 p-6 rounded-xl shadow-lg space-y-6">
      ...
      {/* Results */}
      {results && (
        <div className="bg-yellow-100 p-6 rounded-xl shadow-lg space-y-6">
