...
const CaseStudyHero = ({ title, subtitle, imageUrl, buttonText }: { title: string, subtitle: string, imageUrl: string, buttonText: string }) => {
  return (
    <div className="relative min-h-screen bg-gray-200">
      <Image width={1200} height={650} src={imageUrl} alt="Case Study Background" className="absolute inset-0 object-cover w-full h-full opacity-70" />
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-6 text-white">
        <h1 className="text-4xl md:text-6xl font-extrabold mb-4 leading-tight text-center pt-24 mt-10">
          {title}
        </h1>
