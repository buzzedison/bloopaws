  ...
  return (
    <div className="min-h-screen bg-blue-100 p-10">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-xl mb-10 text-purple-700">The founders of MyCo knew there had to be a better way to manage customer relations. After countless late nights and many cups of coffee, they cracked the code - 
        a revolutionary app called My Center Office (MyCo)..</p>
        <div className="relative mb-10">
          <Image src="/images/casehome.jpg" alt="Abstract Design" width={1500} height={500} />
        </div>
