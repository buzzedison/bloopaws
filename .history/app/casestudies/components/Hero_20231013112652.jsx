  ...
  return (
    <div className="min-h-screen bg-red-100 p-10">
      <div className="max-w-7xl mx-auto py-20">
        <h1 className="text-6xl font-bold mb-8 text-white">Revamping MyCo's Online Presence</h1>
        ...
        <div className="relative mb-10 h-56 md:h-96">
          <Image src="/images/casehome.jpg" alt="MyCo Image" layout="fill" objectFit="cover" />
        </div>
...
export default <CaseStudies></CaseStudies>;
