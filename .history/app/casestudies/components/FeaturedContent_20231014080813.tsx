    ...
    <div className="bg-red-50 ">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center p-10 space-y-6 md:space-y-0">
        ...
        <div className="w-full md:w-1/2 relative h-56 md:h-96">
          <Image src="/images/workwoman.jpg" alt="Woman reading" fill={true} 	style={{objectFit: "contain"}} className="rounded-lg" />
        </div>
      ...
      <div className="flex flex-col md:flex-row-reverse justify-between items-center p-10 space-y-6 md:space-y-0">
