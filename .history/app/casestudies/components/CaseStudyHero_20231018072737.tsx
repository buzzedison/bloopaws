...
const CaseStudyHero = ({ title, subtitle, imageUrl, buttonText }: { title: string, subtitle: string, imageUrl: string, buttonText: string }) => {
  return (
    <div className="relative min-h-screen bg-black">
      ...
      <div className="container mx-auto absolute bottom-0 left-0 z-10 flex flex-col p-8 text-white space-y-4">
        <h1 className="text-4xl md:text-6xl w-3/4 font-extrabold leading-tight">
          {title}
        </h1>
