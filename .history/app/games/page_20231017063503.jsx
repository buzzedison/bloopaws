...
const Quiz = () => {
  ...
  const handleAnswerOptionClick = (value) => {
    ...
    if (nextQuestion < questions.length) {
      ...
      setEntrepreneurialType(foundType.type);
      setShowModal(true);
    }
  };
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white rounded-lg p-8">
            <h2 className="text-2xl font-semibold text-gray-700 mb-4">Your Entrepreneurial Type is:</h2>
            <p className="text-xl text-gray-600 mb-4">{entrepreneurialType}</p>
            <button 
