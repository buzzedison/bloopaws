...
const getReferralStats = async (): Promise<ReferralStats> => {
  return {
    totalReferrals: 12,
    pendingReferrals: 8,
    closedReferrals: 4,
...
export default function ReferralPage() {
  ...
  useEffect(() => {
    ...
    if (!referralId) {
      setReferralId(generateId());
    }
    
    // In a real implementation, we would fetch the user's referral stats here
    // For demo purposes, we'll just set some sample stats
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // In a real implementation, we would save the referral to the database
  ...
  const copyToClipboard = () => {
    const referralLink = `${window.location.origin}/referral?ref=${referralId}`;
  ...
  return (
    <main className="flex flex-col min-h-screen">
      ...
      <section id="services" className="py-24 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mt-12 text-center">
            <a href="#refer-form" className="inline-block px-8 py-4 bg-red-600 hover:bg-red-700 text-white font-bold rounded-lg transition-all shadow-lg hover:shadow-xl">
              Start Referring Now
            </a>
          </div>
        </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-4xl">
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">Share this link with potential clients and earn commissions when they sign up.</p>
            
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
              <div className="flex-1 w-full bg-white border border-gray-300 rounded-lg px-4 py-3 text-left overflow-hidden">
                <p className="truncate">{`${typeof window !== 'undefined' ? window.location.origin : ''}/referral?ref=${referralId}`}</p>
              </div>
              <button 
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a 
                href={`mailto:?subject=Check out this amazing service&body=I thought you might be interested in this service. Check it out: ${typeof window !== 'undefined' ? window.location.origin : ''}/referral?ref=${referralId}`}
                className="bg-gray-800 hover:bg-gray-900 text-white font-medium py-2 px-4 rounded-lg flex items-center gap-2"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              ...
              <a 
                href={`https://twitter.com/intent/tweet?text=Check out this amazing service&url=${typeof window !== 'undefined' ? window.location.origin : ''}/referral?ref=${referralId}`}
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#1DA1F2] hover:bg-[#0c85d0] text-white font-medium py-2 px-4 rounded-lg flex items-center gap-2"
              >
              ...
              <a 
                href={`https://www.linkedin.com/sharing/share-offsite/?url=${typeof window !== 'undefined' ? window.location.origin : ''}/referral?ref=${referralId}`}
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#0A66C2] hover:bg-[#084e96] text-white font-medium py-2 px-4 rounded-lg flex items-center gap-2"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl font-bold text-center mb-12">Your Referral Stats</h2>
