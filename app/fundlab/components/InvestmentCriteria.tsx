...
const criteriaData: CriteriaProps[] = [
  ...
  },
  {
    ...
    imagePath: '/images/fund/demand.png', // Replace with the actual path to your image file
  },
  {
    title: 'Sustainable Model',
    description: 'A business model that promises growth and sustainability.',
    imagePath: '/images/fund/sustainable.png', // Replace with the actual path to your image file
  },
  {
    title: 'Synergy with Values',
    description: 'Alignment with our core values.',
    imagePath: '/images/fund/synergy.png', // Replace with the actual path to your image file
  },
        ...
        {criteriaData.map((criterion, index) => (
          <div key={index} className="bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
            <div className="flex justify-center items-center">
              <Image src={criterion.imagePath} width={250} height={250} alt={criterion.title} layout="fixed" />
            </div>
