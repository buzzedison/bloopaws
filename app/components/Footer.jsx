        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/playbook" className="hover:text-red-600 transition-colors duration-200">
                  The Playbook
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="https://www.facebook.com/bloopglobal" target="_blank" rel="noopener noreferrer" className="hover:text-red-600 transition-colors duration-200 flex items-center">
              ...
              <li>
                <Link href="https://twitter.com/bloopglobal" target="_blank" rel="noopener noreferrer" className="hover:text-red-600 transition-colors duration-200 flex items-center">
                  <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <li>
                <Link href="https://www.linkedin.com/company/bloopglobal" target="_blank" rel="noopener noreferrer" className="hover:text-red-600 transition-colors duration-200 flex items-center">
                  <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <li>
                <Link href="https://www.instagram.com/bloopglobal" target="_blank" rel="noopener noreferrer" className="hover:text-red-600 transition-colors duration-200 flex items-center">
                  <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="mt-16 border-t border-gray-100 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              ...
              <Link href="/contact" className="text-sm text-gray-600 hover:text-red-600 transition-colors duration-200">
                Contact Us
              </Link>
              <Link href="/sitemap" className="text-sm text-gray-600 hover:text-red-600 transition-colors duration-200">
                Sitemap
              </Link>
            </div>
          </div>
